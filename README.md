...
| Ano | Marco |
|-----|-------|
| 🎓 2018 | Graduação em **Administração** |
| 🚀 2023 | Início da jornada técnica em **Engenharia de Software** |
| 🎓 2025 | Início da **Ciência da Computação** + Foco intenso em Java/Spring |
| 💼 2025 | Atuação como **Software Engineer na Sootz** |
| 🛡️ 2026 | **Okta Certified** + Especialização em Defesa Cibernética (FIAP/Cisco) |

---

## 🛠️ Tecnologias & Segurança

### 🛡️ Cybersecurity & Identity (IAM)
...
|--------------|-------------|--------|
| 🏆 **Okta Platform Core Essentials** | Okta | ✅ Concluído |
| 🛡️ **Cyber Academy 2025** | GoHacking | ✅ Concluído |
| 🏆 Engenheiro de Software | Técnico | ✅ Concluído |
| 🎓 Bacharelado em Ciência da Computação | Gran | 🔄 Em andamento |
...
Estou sempre aberto a trocar ideias sobre **Segurança de Aplicações**, **Arquitetura de Sistemas** e **Identity Management**. Se você busca um dev que entenda que a segurança começa na primeira linha de código, vamos conversar!
